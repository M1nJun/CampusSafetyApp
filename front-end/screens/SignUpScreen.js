...
export default function SignUpScreen() {
  ...
  return (
    ...
    >
      ...
      <Text style={{...styles.subHeader, marginBottom: 30}}>Lawrence University</Text>
      ...
      <View style={{ ...styles.widthControll, alignItems: "center", position: "relative" }}>
        ...
        />
        {showPassword? <TouchableOpacity style={{ position: "absolute", right: 33, top: "50%", transform: [{ translateY: -12 }] }} onPress={() => setShowPassword(false)} >
        <Ionicons name="eye-off" size={24} color="black" />
        </TouchableOpacity> :  <TouchableOpacity style={{ position: "absolute", right: 33, top: "50%", transform: [{ translateY: -12 }] }} onPress={() => setShowPassword(true)} >
          <Ionicons 
            name="eye" 
            size={24} 
            color="black" 
